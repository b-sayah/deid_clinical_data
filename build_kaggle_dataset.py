...
if __name__ == "__main__":
    ...
    path_dataset = '../../../cs230-code-examples-master/nlp/data/kaggle/ner_dataset.csv'
    ...
    save_dataset(train_dataset, '../../../cs230-code-examples-master/nlp/data/kaggle/train')
    save_dataset(val_dataset, '../../../cs230-code-examples-master/nlp/data/kaggle/val')
    save_dataset(test_dataset, '../../../cs230-code-examples-master/nlp/data/kaggle/test')